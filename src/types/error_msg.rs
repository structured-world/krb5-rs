//! KRB-ERROR message type (RFC 4120 §5.9.1).

use rasn::prelude::*;

use super::basic::PrincipalName;
use super::primitives::*;

/// KRB-ERROR (APPLICATION 30) — RFC 4120 §5.9.1.
...
pub struct KrbErrorMsg {
    ...
    pub e_text: Option<GeneralString>,
    #[rasn(tag(explicit(context, 12)))]
    pub e_data: Option<OctetString>,
}

/// Standard KDC error codes (RFC 4120 §7.5.9).
pub mod error_codes {
    ...
    pub const KDC_ERR_CLIENT_NOT_TRUSTED: i32 = 62;
    pub const KDC_ERR_KDC_NOT_TRUSTED: i32 = 63;
    pub const KDC_ERR_INVALID_SIG: i32 = 64;
    pub const KDC_ERR_DH_KEY_PARAMETERS_NOT_ACCEPTED: i32 = 65;
